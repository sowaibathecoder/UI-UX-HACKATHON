    ...
    <>
      <div className="w-[1440px] h-[124px] border border-[#C3D4E966] bg-white relative">
        ...
        <div className="w-[492px] h-[44px] absolute top-[40px] left-[272px] rounded-full border border-solid border-[#C3D4E966]">
          ...
          />
          <div className="w-[149px] h-[20px] absolute top-[12px] left-16 font-['Plus_Jakarta_Sans'] text-sm font-medium leading-[21px] tracking-[-0.02em] text-justify text-[#596780]">
          ...
          <Image
            ...
            width={24}
            height={24}
            className="absolute top-[10px] left-[445px]"
          />
        </div>
